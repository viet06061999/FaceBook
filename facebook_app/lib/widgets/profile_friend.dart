...
class ProfileFriend extends StatefulWidget {
  ...
  UserEntity provideFriend;

  ProfileFriend(this.provide) {
    provide.getFriends(provide.userEntity);
    provide.getUserListPost(provide.userEntity.id);
  }
...
class _ProfileFriend extends State<ProfileFriend> {
                  ...
                  children: <Widget>[
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        if (provide.userEntity.description != null)
                          Text(
                            provide.userEntity.description,
              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    if (provide.userEntity.city != "") SizedBox(height: 15.0),
                    if (provide.userEntity.city != "")
                      Row(
                        children: <Widget>[
                          ...
                          child: GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => SettingProfile(provide)),
                                );
                              },
                      ...
                      children: <Widget>[
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            SizedBox(height: 6.0),
                            Text(provide.friends.length.toString() + ' người bạn',
                                style: TextStyle(
