...
class RegisterPageFive extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _RegisterPageState(firstName, lastName, birthday, gender);
}
  ...
  onContinueClick() {
    if (_isTextNull == null || _isTextNull){
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => RegisterPageSix(
                  firstName, lastName, birthday, gender, _phoneController.text )));
    }
  }
