...
import 'package:facebook_app/src/resources/register/register_page_step_four.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:facebook_app/src/ultils/time_ext.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        color: Colors.white,
        child: ListView(
          children: [buildTextTop(),Expanded(child: buildDatePicker()) , buildButtonContinue()],
        ),
      ),
    );
  }
